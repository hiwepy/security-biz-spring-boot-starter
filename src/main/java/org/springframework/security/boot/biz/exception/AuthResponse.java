...
public class AuthResponse<T> {
    ...
    protected AuthResponse(final String code, final String message) {
        this(code, AuthConstants.RT_SUCCESS, message);
    }
    
    protected AuthResponse(final String code, final String status, final String message) {
        this.code = code;
        this.status = status;
        this.message = message;
    }
    
    protected AuthResponse(final String code, final String message, final T data) {
        this(code, AuthConstants.RT_SUCCESS, message, data);
    }
    
    protected AuthResponse(final String code, final String status, final String message, final T data) {
        this.code = code;
        this.status = status;
        this.message = message;
        this.data = data;
    ...
    public static <T> AuthResponse<T> success(final String code, final String message) {
    ...
    public static <T> AuthResponse<T> fail(final String code, final String message) {
    	return of(code, AuthConstants.RT_FAIL, message);
    }
    
    // error -----------------------------------------------------------------
    
    public static <T> AuthResponse<T> error(final String message) {
    	return of(AuthResponseCode.SC_AUTHC_ERROR, message, null);
    }
    
    public static <T> AuthResponse<T> error(final T data) {
        return of(AuthResponseCode.SC_AUTHC_ERROR, data);
    }
    
    public static <T> AuthResponse<T> error(final int code, final String message) {
        return error(String.valueOf(code), message);
    }
    
    public static <T> AuthResponse<T> error(final String code, final String message) {
        return of(code, AuthConstants.RT_ERROR, message);
    }
    ...
    public static <T> AuthResponse<T> of(final int code, final String status, final String message) {
        return of(String.valueOf(code), status, message, null);
    }
    ...
    public static <T> AuthResponse<T> of(final String code, final String status, final String message, final T data) {
